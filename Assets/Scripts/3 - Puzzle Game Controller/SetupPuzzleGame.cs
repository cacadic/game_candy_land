...
public class SetupPuzzleGame : MonoBehaviour
{
    ...
    private void Awake()
    {
        candyPuzzleSprites = Resources.LoadAll<Sprite>("Sprites/Game Assets/Candy Items");
        transportPuzzleSprites = Resources.LoadAll<Sprite>("Sprites/Game Assets/Cake Items");
        fruitPuzzleSprites = Resources.LoadAll<Sprite>("Sprites/Game Assets/Fruit Items");
    }
